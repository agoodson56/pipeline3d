...
const GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        content: [
            { heading: 'Composing & Sending', text: '1. Go to Email in the sidebar → click ✉ Compose\n2. Select a Contact (auto-fills their email) and Related Deal\n3. Write your email or use AI to draft it\n4. Click 📤 Send via Gmail\n5. Gmail opens in a new tab with To, Subject, and Body already filled in\n6. Click Send in Gmail — done! The email is delivered AND logged in Pipeline3D\n\n💡 If you use Outlook instead of Gmail, your default email client will open with the email pre-filled.' },
