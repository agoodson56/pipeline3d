...
const GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        content: [
            ...
            { heading: 'Win/Loss Reason Capture', text: 'When you move a deal to Won or Lost (via drag-and-drop or stage buttons), Pipeline3D prompts you:\n• Select a reason from the dropdown (e.g. "Best Price", "Lost to Competitor", "Budget Cut")\n• Add optional notes for additional context\n• Click Confirm to save\n\nWin reasons: Best Price, Scope Fit, Relationship, Technical Capability, Timeline, Bundled Services, Existing Customer, Other\nLoss reasons: Price Too High, Lost to Competitor, Project Cancelled, Decision Delayed, Went In-House, Scope Changed, No Response, Budget Cut, Other\n\n💡 Tip: Over time, win/loss patterns become the most valuable data your sales team has. Use Reports to analyze trends.' },
            { heading: 'Deal Detail Tabs', text: 'Click any deal card to see 7 tabs:\n• Details — value, stage, contact, probability, days open, expected close date, win/loss reason\n• ✏️ Edit — modify deal fields\n• Products — add line items (name, qty, price) — auto-calculates total\n• Activities — all calls, meetings, emails, and tasks linked to this deal\n• Emails — full email history sent through the Email Composer for this deal\n• Notes — add timestamped notes (press Enter or click Add)\n• History — automatic timeline of all changes including win/loss events' },
            { heading: 'Overdue Close Date Alerts', text: 'Deals with a past-due Expected Close date show a red ⏰ Overdue badge directly on the Kanban card. In the deal detail, the Expected Close field turns red with "OVERDUE" text.\n\n💡 Tip: Review overdue deals weekly to either update the close date or take action to move them forward.' },
    ...
    },
    {
        ...
        content: [
            { heading: 'Composing & Sending', text: '1. Go to Email in the sidebar → click ✉ Compose\n2. Select a Contact (auto-fills their email) and Related Deal\n3. Write your email or use AI to draft it\n4. Click 📤 Send via Outlook\n5. Outlook opens in a new tab with To, Subject, and Body already filled in\n6. Click Send in Outlook — done! The email is delivered AND logged in Pipeline3D\n\n💡 If Outlook Web is not available, your desktop Outlook app will open with the email pre-filled.' },
    ...
    },
    {
        ...
        content: [
            ...
            { heading: '📋 RFP Response Drafting', text: 'Generate a complete technical response to an RFP:\n1. Select a deal\n2. Click 📋 RFP Response (purple button)\n3. AI generates 8 sections tailored to the trade:\n   • Technical Understanding & Approach\n   • Scope of Work (equipment, installation, testing, training)\n   • Applicable Standards & Compliance (BICSI, NFPA, NEC, UL, ADA)\n   • Compliance Matrix (requirement → status table)\n   • Project Team & Qualifications (RCDD, NICET, certs)\n   • Project Schedule (mobilization → closeout)\n   • Warranty & Support\n   • Differentiators (why choose 3DTSI)\n4. Click 📋 Copy to paste into your response document\n\n💡 The RFP response is trade-specific. A CCTV deal generates camera standards, a fire alarm deal references NFPA 72, a cabling deal cites BICSI standards.' },
        ]
    },
    {
